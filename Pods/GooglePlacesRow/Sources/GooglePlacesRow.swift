...
public class _GooglePlacesRow<Cell: GooglePlacesCell>: FieldRow<Cell>, GooglePlacesRowProtocol {
    ...
    func autoComplete(text: String) {
        placesAutoComplete.getPlacesResults(searchString: text)
        self.cell.predictions = placesAutoComplete.getPlacesResults(searchString: text)
        self.cell.reload()
